...
export const AntributeLogo = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    >
      <circle cx={128} cy={128} r={128} fill="#219EBC" />
    </mask> */}
    <g mask="url(#backgroundPath)">
      ...
      <path
        ...
        className="fill-palette-content-inverse-intense"
    ...
    <defs>
      ...
      <SvgLinearGradient
        id="backgroundPath"
        stops={[
          { color: caution.DEFAULT, opacity: 0.5 },
          { color: info.DEFAULT, opacity: 0.5 },
          { color: heart.DEFAULT, opacity: 0.5 },
        ]}
      />
      <SvgLinearGradient
        id="foregroundPath"
        stops={[
          { color: caution.DEFAULT },
          { color: info.DEFAULT },
          // { color: heart.DEFAULT }
        ]}
      />
      {/* <SvgLinearGradient
        id="background"
        stops={[
          { color: caution.DEFAULT, offset: 10 },
          { color: info.DEFAULT, offset: 60 },
          // { color: success.DEFAULT, offset: 70 },
          { color: heart.DEFAULT },
        ]}
      /> */}
    </defs>
