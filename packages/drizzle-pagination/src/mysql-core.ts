 ...
 */
export const withCursorPagination = <QbType extends MySqlSelect, CursorCol extends MySqlColumn>(
  qb: QbType,
  cursorCol: CursorCol,
 ...
 */
export const withLimitOffsetPagination = <QbType extends MySqlSelect>(
  qb: QbType,
  page: number | null,
  pageSize = 10
) => {
