 ...
 */
export const withCursorPagination = <QbType extends SQLiteSelect, CursorCol extends SQLiteColumn>(
  qb: QbType,
  cursorCol: CursorCol,
 ...
 */
export const withLimitOffsetPagination = <QbType extends SQLiteSelect>(
  qb: QbType,
  page: number | null,
  pageSize = 10
) => {
